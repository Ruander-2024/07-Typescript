...
console.log('----Összes konyv adata----');
...
console.table(myBookshelf.userBookshelf.getAuthorOfMostWrittenPages());

console.log('--- Legkönnyebb könyv ---');
console.table(myBookshelf.userBookshelf.getLightestAuthor());
